// Explicit source-date records for the exact 23 routes in the frozen
// August 10 batch. This is intentionally route-shaped so each date belongs
// to the article record it authenticates.
export const august10BlogV6DateRecords = [
