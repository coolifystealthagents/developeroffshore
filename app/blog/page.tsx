...
export const metadata = {
  ...
  description: 'Practical guides for planning, reviewing, and managing Philippines-based software development work.',
  alternates: { canonical: 'https://developeroffshore.com/blog' },
};
