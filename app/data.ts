...
import { september4BlogBatch } from './sep04-blog-batch';
import { september7BlogBatch } from './sep07-blog-batch';
import { september8BlogBatch } from './sep08-blog-batch';
import { september9BlogBatch } from './sep09-blog-batch';
import { september10BlogBatch } from './sep10-blog-batch';
import { september18BlogBatch } from './sep18-blog-batch';
...
const dailyBlogBatch: BlogPost[] = routineTopics.slice(0, 20).map((topic) => ({
  ...
  relatedLinks: [
    ...
    { label: 'Talk through the role', href: '/contact', note: 'Share the stack, outcome, schedule, and review owner.' },
  ],
  faqs: [
