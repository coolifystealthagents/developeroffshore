...
export const metadata: Metadata = { title: { absolute: 'Offshore Developers in the Philippines | Developer Offshore' }, description: 'Plan Philippines-based developer roles around your backlog, stack, access controls, code review, and delivery schedule.', alternates: { canonical: 'https://developeroffshore.com/' } };
